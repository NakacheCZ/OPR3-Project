...
public class SubCaliberPresetResponse {
    private Long id;
    private String name;
    ...
    public SubCaliberPresetResponse(Long id, String name, Double totalLength, Double diameter, Double densityPenetrator,
                                    Double hardnessPenetrator, Double velocity, Double densityTarget, Double hardnessTarget,
